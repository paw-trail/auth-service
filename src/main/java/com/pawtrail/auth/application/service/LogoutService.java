...
public class LogoutService {
    ...
    public void logout(String refreshTokenValue) {
        ...
        // 저장소에서 지웁니다. 이 시점부터 그 토큰으로는 갱신할 수 없습니다.
        //
        // 갱신과 같은 메서드를 쓰는 이유는 저장소에 시킬 일이 "읽으면서 지운다" 로 같기 때문입니다.
        // 돌려받은 계정 식별자는 여기서 쓰지 않습니다.
        ...
        // 직전에 교체된 토큰의 유예 항목은 지우지 않습니다.
        //
        // 그 항목의 키가 옛 토큰의 jti 인데 지금 들어온 것은 새 토큰이라 알 수 없습니다.
